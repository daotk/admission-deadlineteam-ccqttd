...
public class Dictionary_DAO_Implement implements Dictionary_DAO {
	...
	*/
	...
	public Dictionary getinformation(int ID) {
		Dictionary information = (Dictionary) getCurrentSession().createQuery(
				" from Dictionary where ID = " + ID).uniqueResult();
		return information;
	}
	...
	public void addDictionaryAnswer(String title, String question, String answer) {
		// String sqlstring =
		// "update Questionmanagement set Title = :title, Question = :question, Answer = :answer where ID = '5'";
		String sqlstring = "INSERT INTO Questionmanagement (ID, Title, Question, Answer) VALUES (33,'"
				+ title + "', '" + question + "','" + answer + "')";
		Query q = (Query) sessionFactory.getCurrentSession().createSQLQuery(
				sqlstring);
		q.executeUpdate();
	}

	@Override
	public void addDictionaryAnswer2(String title, String question,
			int createby, String answer, int answerby, Date CreateDate,
			int status, int deletestatus, int busystatus) {
		String sqlstring1 = "INSERT INTO dictionary (Title, Question, CreateBy, Anwser, AnwserBy, CreateDate, Status, DeleteStatus) VALUES ('"
				+ title
				+ "', '"
				+ question
				+ "', "
	...
	public Users getusername(int ID) {
		Users username = (Users) getCurrentSession().createQuery(
				" from Users where ID = " + ID).uniqueResult();
		return username;
	}
