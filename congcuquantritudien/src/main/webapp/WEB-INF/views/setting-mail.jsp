        ...
        <div class="body">
 			...
 			<form method="post" action=""  style="text-align: left;">
 				<table style="margin-left: 2%; margin-top: 2%;">
 					...
 					<tr>
 						<td></td>
 						<td><button class="buttoncontrol" id="change" type="submit"  name="actionsubmit" value="change" style="height: 35px; float: right; margin-right: 0;" onclick="$('#loading').show();">Thay đổi</button></td>
 					</tr>
				</table>
			</form>
 		</div>
